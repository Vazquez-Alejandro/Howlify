      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gray-950 px-4">
          <div className="text-center max-w-md">
            ...
            <p className="text-gray-500 text-sm mb-6">Algo salió mal. El Lobo ya está investigando.</p>
            <div className="flex gap-3 justify-center">
              ...
              <a href="/" className="px-5 py-3 bg-gray-800/50 text-gray-300 rounded-xl text-sm font-semibold hover:bg-gray-700/50 transition-all border border-gray-700/50">
                Volver al inicio
              </a>
            </div>
