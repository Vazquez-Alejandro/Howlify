      ...
      <div className="min-h-screen bg-gray-950 text-white">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-6 pt-24 pb-28 text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link to="/register" className="w-full sm:w-auto px-8 py-4 bg-white text-gray-950 rounded-xl font-semibold text-base hover:bg-gray-100 transition-all shadow-xl shadow-white/5">
                Empezar gratis — 7 días
              </Link>
              <Link to="/login" className="w-full sm:w-auto px-8 py-4 bg-gray-800/60 border border-gray-700/50 text-gray-300 rounded-xl font-semibold text-base hover:bg-gray-700/50 hover:text-white transition-all">
                Ya tengo cuenta
              </Link>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {FEATURES.map((f) => (
                <div key={f.title} className="group p-6 rounded-2xl bg-gray-900/40 border border-gray-800/60 hover:border-gray-700/60 hover:bg-gray-900/60 transition-all duration-300">
                  <div className="w-11 h-11 rounded-xl bg-red-500/10 border border-red-500/20 flex items-center justify-center text-red-400 mb-5 group-hover:bg-red-500/15 transition-colors">
                    {f.icon}
                  </div>
            ...
            <div className="space-y-3">
              {[
                ...
                <details key={item.q} className="group rounded-2xl bg-gray-900/40 border border-gray-800/60 overflow-hidden">
                  <summary className="px-6 py-5 cursor-pointer text-sm font-medium text-white hover:text-red-400 transition-colors flex items-center justify-between list-none">
                    {item.q}
        ...
        <section className="py-20">
          <div className="max-w-3xl mx-auto px-6">
            <div className="relative rounded-3xl bg-gradient-to-b from-red-500/10 to-gray-900/80 border border-red-500/20 p-12 sm:p-16 text-center overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <Link to="/register" className="inline-block px-10 py-4 bg-white text-gray-950 rounded-xl font-semibold text-base hover:bg-gray-100 transition-all shadow-xl shadow-white/5">
                  Crear cuenta gratis
                </Link>
              </div>
            </div>
